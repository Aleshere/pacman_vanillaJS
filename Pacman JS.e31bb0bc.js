...
var POWER_PILL_TIME = 8000; // milliseconds
...
function gameLoop(pacman, ghosts) {
  ...
  checkCollision(pacman, ghosts); // Check if pacman eats the dot
  ...
  if (gameBoard.objectExist(pacman.pos, _setup.OBJECT_TYPE.DOT)) {
    ...
    gameBoard.dotCount--;
    score += 10;
  } //Check if pacman eats the power pill
...
//# sourceMappingURL=/Pacman%20JS.e31bb0bc.js.map